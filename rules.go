...
var (
	...
	tabletDevices = [...]string{
		...
		//ASUSTABLET:
		`^.*PadFone.*$|Transformer|TF101|TF101G|TF300T|TF300TG|TF300TL|TF700T|TF700KL|TF701T|TF810C|ME171|ME301T|ME302C|ME371MG|ME370T|ME372MG|ME172V|ME173X|ME400C|Slider SL101|\bK00F\b|TX201LA`,
		//BLACKBERRYTABLET:
		`PlayBook|RIM Tablet`,
		//HTCTABLET:
		...
		//LGTABLET:
		`\bL-06C|LG-V900|LG-V500|LG-V909\b`,
		//FUJITSUTABLET:
		...
		//LENOVOTABLET:
		`IdeaTab|S2110|S6000|K3011|A3000|A1000|A2107|A2109|A1107|ThinkPad([ ]+)?Tablet`,
		...
		//INTENSOTABLET:
		`INM8002KP|INM1010FP|INM805ND|Intenso Tab`,
		...
		//ARCHOSTABLET:
		`\b(101G9|80G9|A101IT)\b|Qilive 97R|ARCHOS 101G10`,
		...
		//SONYTABLET:
		`Sony.*Tablet|Xperia Tablet|Sony Tablet S|SO-03E|SGPT12|SGPT13|SGPT114|SGPT121|SGPT122|SGPT123|SGPT111|SGPT112|SGPT113|SGPT131|SGPT132|SGPT133|SGPT211|SGPT212|SGPT213|SGP311|SGP312|SGP321|EBRD1101|EBRD1102|EBRD1201`,
	...
	operatingSystems = [...]string{
		...
		//WINDOWSPHONEOS:
		`Windows Phone 8.0|Windows Phone OS|XBLWP7|ZuneWP7`,
		//IOS:
