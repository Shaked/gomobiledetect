...
var (
	phoneDevices = [...]string{
		...
		//NEXUS:
		`Nexus One|Nexus S|Galaxy.*Nexus|Android.*Nexus.*Mobile`,
		...
		//SONY:
		`SonyST|SonyLT|SonyEricsson|SonyEricssonLT15iv|LT18i|E10i|LT28h|LT26w|SonyEricssonMT27i|C6902|C6903|C6906|C6943`,
		//ASUS:
	...
	tabletDevices = [...]string{
		...
		//ASUSTABLET:
		`^.*PadFone.*$|Transformer|TF101|TF101G|TF300T|TF300TG|TF300TL|TF700T|TF700KL|TF701T|TF810C|ME171|ME301T|ME302C|ME371MG|ME370T|ME372MG|ME172V|ME173X|ME400C|Slider SL101|\bK00F\b|\bK00C\b|\bK00E\b|\bK00L\b|TX201LA|ME176C|ME102A|\bM80TA\b|ME372CL|ME560CG|ME372CG`,
		//BLACKBERRYTABLET:
		`PlayBook|RIM Tablet`,
		//HTCTABLET:
		`HTC Flyer|HTC Jetstream|HTC-P715a|HTC EVO View 4G|PG41200|PG09410`,
		//MOTOROLATABLET:
		...
		`\bL-06C|LG-V900|LG-V500|LG-V909|LG-V500|LG-V510|LG-VK810\b`,
		//FUJITSUTABLET:
		...
		//VODAFONETABLET:
		`SmartTab([ ]+)?[0-9]+|SmartTabII10|SmartTabII7`,
		...
		`T-Hub2`,
		//GenericTablet
		//@full, notice Tablet(?!.*PC) - `Android.*\b97D\b|Tablet(?!.*PC)|BNTV250A|MID-WCDMA|LogicPD Zoom2|\bA7EB\b|CatNova8|A1_07|CT704|CT1002|\bM721\b|rk30sdk|\bEVOTAB\b|M758A|ET904|ALUMIUM10|Smartfren Tab|Endeavour 1010|Tablet-PC-4|Tagi Tab|\bM6pro\b|CT1020W`,
		`Android.*\b97D\b|BNTV250A|MID-WCDMA|LogicPD Zoom2|\bA7EB\b|CatNova8|A1_07|CT704|CT1002|\bM721\b|rk30sdk|\bEVOTAB\b|M758A|ET904|ALUMIUM10|Smartfren Tab|Endeavour 1010|Tablet-PC-4|Tagi Tab|\bM6pro\b|CT1020W`,
...
func (r *rules) setMobileDetectionRules() {
